  ...
  return (
    <main className='bg-background flex flex-col relative my-16 lg:mt-0 md:pt-20 p-5 h-screen'>
      <section className='inline-flex justify-between my-7 items-center lg:gap-40'>
        <span className='font-serif capitalize sm:text-2xl lg:text-3xl'>Writing History</span>
      ...
      <section className='inline-flex my-5 items-center justify-between md:w-2/3 lg:w-1/2'>
        ...
        <NavLink to="." end className={({isActive})=>`flex items-center justify-center w-20 md:w-30 lg:w-40 lg:text-[17px] px-4 p-2 mx-2 rounded-3xl ${!isActive ?"bg-gray-300 text-primary font-bold":"bg-primary text-white" }`}>Drafts</NavLink>
