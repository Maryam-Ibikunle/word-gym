...
const Home = () => {
  return (
    <main className='max-w-7xl bg-background flex flex-col relative w-full my-16 p-5 h-screen overflow-y-scroll'>
        <section>
            <h2 className='text-2xl '>Good morning, Maryam</h2>
            <p className='font-sans tracking-wider mt-2'>The morning light is perfect for writing.</p>
        </section>

        <section className='backdrop-blur-xl bg-[#fff5ec] rounded-3xl my-7 p-6 text-[20px]'>
            <div className='flex flex-row justify-between items-center pb-6' >
                <div className='text-[#2d2426]'>
                    <h2 className='p-3 bg-secondary/30 rounded-3xl '>Daily Prompt</h2>
                    <p className='font-serif'>The Last Train</p>
                </div>
                <div className='text-primary bg-white p-3 rounded-[50%] font-bold'><Train/></div>
            </div>

            <div className='font-sans'>A lone figure waits at the station at 3:00 AM. The display board shows a...</div>

            <button className='inline-flex gap-5 bg-linear-to-r from-primary to-primary/60 text-white tracking-wider justify-center items-center w-full h-12 rounded-3xl py-4'><Pen className='text-[5px]'/> <span>Start Writing</span></button>
        </section>

        <section className='grid grid-cols-2 gap-4'> 
            <div className='bg-[#fff8f0] rounded-3xl p-4 border border-primary/10 flex flex-col gap-6 not-last-of-type:justify-between'>
            ...
            <div className='bg-white rounded-3xl p-4 border border-primary/10 flex flex-col gap-6 not-last-of-type:justify-between'>
                <div className='inline-flex gap-1 items-center'>
        ...
        <section className='my-7 text-[20px]'>
            <h2>Weekly Pulse</h2>
            <div className='bg-gray-100 p-1 rounded-3xl'>
                <div className=' flex flex-row justify-between bg-white rounded-3xl h-20 items-center p-4'>
                ...
                <div className=' flex flex-row justify-between bg-white rounded-3xl h-20 items-center p-4 mt-2'>
                    <div className='w-10 h-10 rounded-[50%] text-primary bg-tertiary/70 flex items-center justify-center'><PaperclipIcon className=' '/></div>
                    <div>
                        <p>Time in Flow</p>
                        <p>6hr 15m</p>
